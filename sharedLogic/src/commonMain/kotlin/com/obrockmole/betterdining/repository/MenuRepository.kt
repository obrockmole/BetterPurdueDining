...
import com.obrockmole.betterdining.graphql.GetLocationMenuQuery
...
class MenuRepository {
    ...
    suspend fun getDiningCourtMenu(
        ...
        try {
            ...
            Logger.LogError(LOG_TAG, "An error occurred getting the menu for $courtId")
            throw e
        }
    }
    ...
    suspend fun getItemDetails(itemId: String): GetItemDetailsQuery.ItemByItemId? {
        try {
            ...
            Logger.LogError(LOG_TAG, "An error occurred getting details for $itemId")
            throw e
        }
    }
}
